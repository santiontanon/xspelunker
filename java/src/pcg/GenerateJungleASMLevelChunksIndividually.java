 ...
 * @author santi
 */
public class GenerateJungleASMLevelChunksIndividually {
    ...
    public static void main(String args[]) throws Exception {
        String prefix = "jungle";
        String chunks[]={"data/rooms-jungle/foliage-1.tmx",
                         "data/rooms-jungle/foliage-2.tmx",
                         "data/rooms-jungle/room1-1.tmx",
                         "data/rooms-jungle/room1-2.tmx",
                         "data/rooms-jungle/room1-3.tmx",
                         "data/rooms-jungle/room1-4.tmx",
                         "data/rooms-jungle/room2-1.tmx",
                         "data/rooms-jungle/room2-2.tmx",
                         "data/rooms-jungle/room3-1.tmx",
                         "data/rooms-jungle/room3-2.tmx",
                         "data/rooms-jungle/room3-3.tmx",
                         "data/rooms-jungle/room4-1.tmx",
                         "data/rooms-jungle/room4-2.tmx",
                         "data/rooms-jungle/room5-1.tmx",
                         "data/rooms-jungle/room5-2.tmx",
                         "data/rooms-jungle/room5-3.tmx",
                         "data/rooms-jungle/room6-1.tmx",
                         "data/rooms-jungle/room6-2.tmx",
                         "data/rooms-jungle/room6-3.tmx",
                         "data/rooms-jungle/room6-4.tmx",
                         "data/rooms-jungle/room1-bottom-1.tmx",
                         "data/rooms-jungle/room1-bottom-2.tmx",
                         "data/rooms-jungle/room3-bottom-1.tmx",
                         "data/rooms-jungle/room4-bottom-1.tmx",
                         "data/rooms-jungle/doubleroom-1.tmx",
                         "data/rooms-jungle/doubleroom-2.tmx"};
        String chunk_types[] = {
                             "PCG_CHUNK_BACKGROUND + PCG_CHUNK_TOP",
                             "PCG_CHUNK_BACKGROUND + PCG_CHUNK_TOP",
                             "PCG_CHUNK_FG_TYPE1","PCG_CHUNK_FG_TYPE1","PCG_CHUNK_FG_TYPE1","PCG_CHUNK_FG_TYPE1",
                             "PCG_CHUNK_FG_TYPE2","PCG_CHUNK_FG_TYPE2",
                             "PCG_CHUNK_FG_TYPE3","PCG_CHUNK_FG_TYPE3","PCG_CHUNK_FG_TYPE3",
                             "PCG_CHUNK_FG_TYPE4","PCG_CHUNK_FG_TYPE4",
                             "PCG_CHUNK_FG_TYPE5","PCG_CHUNK_FG_TYPE5","PCG_CHUNK_FG_TYPE5",
                             "PCG_CHUNK_FG_TYPE6","PCG_CHUNK_FG_TYPE6","PCG_CHUNK_FG_TYPE6","PCG_CHUNK_FG_TYPE6",
                             "PCG_CHUNK_FG_TYPE1 + PCG_CHUNK_BOTTOM","PCG_CHUNK_FG_TYPE1 + PCG_CHUNK_BOTTOM",
                             "PCG_CHUNK_FG_TYPE3 + PCG_CHUNK_BOTTOM","PCG_CHUNK_FG_TYPE4 + PCG_CHUNK_BOTTOM",
        ...
        ps.println("  db " + chunks.length + "    ; the first byte is the number of chunks");
        ...
        for(int i = 0;i<chunks.length;i++) {
            ...
            translateLevelChunkToASM("jungle_chunk" + i, lc, ps2);
            ps2.flush();
            ps2.close();
        }
    }
