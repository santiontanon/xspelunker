 ...
 * @author santi
 */
public class GenerateOuterRuinsASMLevelChunksIndividually {
    ...
    public static void main(String args[]) throws Exception {
        String prefix = "outerruins";
        String chunks[]={"data/rooms-outer-ruins/background1.tmx",
                         "data/rooms-outer-ruins/background2.tmx",
                         "data/rooms-outer-ruins/room1-1.tmx",
                         "data/rooms-outer-ruins/room1-2.tmx",
                         "data/rooms-outer-ruins/room1-3.tmx",
                         "data/rooms-outer-ruins/room2-1.tmx",
                         "data/rooms-outer-ruins/room2-2.tmx",
                         "data/rooms-outer-ruins/room2-3.tmx",
                         "data/rooms-outer-ruins/room3-1.tmx",
                         "data/rooms-outer-ruins/room3-2.tmx",
                         "data/rooms-outer-ruins/room3-3.tmx",
                         "data/rooms-outer-ruins/room4-1.tmx",
                         "data/rooms-outer-ruins/room4-2.tmx",
                         "data/rooms-outer-ruins/room4-3.tmx",
                         "data/rooms-outer-ruins/room5-1.tmx",
                         "data/rooms-outer-ruins/room5-2.tmx",
                         "data/rooms-outer-ruins/room5-3.tmx",
                         "data/rooms-outer-ruins/room6-1.tmx",
                         "data/rooms-outer-ruins/room6-2.tmx",
                         "data/rooms-outer-ruins/room6-3.tmx",
                         "data/rooms-outer-ruins/room1-bottom-1.tmx",
                         "data/rooms-outer-ruins/room1-bottom-2.tmx",
                         "data/rooms-outer-ruins/doubleroom1.tmx",
                         "data/rooms-outer-ruins/doubleroom2.tmx"};
        String chunk_types[] = {
                             "PCG_CHUNK_BACKGROUND",
                             "PCG_CHUNK_BACKGROUND",
        ...
        for(int i = 0;i<chunks.length;i++) {
            ...
            translateLevelChunkToASM("outerruins_chunk" + i, lc, ps2);
            ps2.flush();
            ps2.close();
        }
    }
